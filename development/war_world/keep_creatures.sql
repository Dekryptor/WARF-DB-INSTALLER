...
--
-- Table structure for table `keep_creatures`
--
...
--
-- Dumping data for table `keep_creatures`
--

LOCK TABLES `keep_creatures` WRITE;
/*!40000 ALTER TABLE `keep_creatures` DISABLE KEYS */;
/*!40000 ALTER TABLE `keep_creatures` ENABLE KEYS */;
UNLOCK TABLES;
